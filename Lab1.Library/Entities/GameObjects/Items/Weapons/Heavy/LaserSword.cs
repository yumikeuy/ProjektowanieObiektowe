...
{
    public class LaserSword : WeaponWithTwoHandles, IHeavyWeapon
    {
        public override int Damage { get; set; } = 7;
        public override char Char { get; set; } = 'I';
        protected override string _description { get; set; } = "Laser Sword";
